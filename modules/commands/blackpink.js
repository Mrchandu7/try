...
"https://i.imgur.com/DvEWRgb.jpg",
	 ...
	 var callback = () => api.sendMessage({body:`Here's the Blaclpink group's profile \nAvailable number of photos: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
